...
export const consoleWarn = () => {
    ...
    console.log("%cDo not enter any code or instructions here unless you understand them and know they are safe. If you have been instructed to paste something here to enable a hidden feature or fix an issue, it is likely a scam that could harm your account or compromise your personal data.", "font-size: 20px;");
    return null
}